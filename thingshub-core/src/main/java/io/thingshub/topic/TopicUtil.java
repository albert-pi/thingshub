...
public class TopicUtil {
	...
	public static final String THING_PROPERTY_POST_TOPIC_FORMAT = "devices/%s/%s/thing/property/%s/post";
	public static final String THING_PROPERTY_POST_REPLY_TOPIC_FORMAT = "devices/%s/%s/thing/property/%s/post_reply";
	public static final String THING_PROPERTY_SET_TOPIC_FORMAT = "devices/%s/%s/thing/property/%s/set";
	public static final String THING_PROPERTY_SET_REPLY_TOPIC_FORMAT = "devices/%s/%s/thing/property/%s/set_reply";
	public static final String THING_SERVICE_REQUEST_TOPIC_FORMAT = "devices/%s/%s/thing/service/%s/request";
	public static final String THING_SERVICE_REQUEST_REPLY_TOPIC_FORMAT = "devices/%s/%s/thing/service/%s/request_reply";
	public static final String THING_SERVICE_CALL_TOPIC_FORMAT = "devices/%s/%s/thing/service/%s/call";
	public static final String THING_SERVICE_CALL_REPLY_TOPIC_FORMAT = "devices/%s/%s/thing/service/%s/call_reply";
	public static final String THING_EVENT_POST_TOPIC_FORMAT = "devices/%s/%s/thing/event/%s/post";
	public static final String THING_EVENT_POST_REPLY_TOPIC_FORMAT = "devices/%s/%s/thing/event/%s/post_reply";
