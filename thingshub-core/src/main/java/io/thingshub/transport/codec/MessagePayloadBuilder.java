...
public class MessagePayloadBuilder {
	...
	private static final Charset DEFAULT_STRING_ENCODING = Charset.forName("GBK");
	...
	public static MessagePayloadBuilder newBuilder() {
	...
	private MessagePayloadBuilder(int initialCapacity, int maxCapacity) {
	...
	public MessagePayloadBuilder append(byte[] bytes) {
	...
	public MessagePayloadBuilder appendByte(int b) {
		return this.appendByte((byte) b);
	}

	public MessagePayloadBuilder appendByte(byte b) {
		ensureWritable(1);
		setByte(b);
		return this;
	}

	public MessagePayloadBuilder appendBytes(byte[] bytes) {
		return this.append(bytes);
	}

	public MessagePayloadBuilder appendWord(int data) {
		ensureWritable(2);
	...
	public MessagePayloadBuilder appendDword(int data) {
		return this.appendDword((long) data);
	}

	public MessagePayloadBuilder appendDword(long data) {
		ensureWritable(4);
	...
	public MessagePayloadBuilder appendBcd(String bcd) {
		append(BcdOps.strToBcd(bcd));
		return this;
	}

	public MessagePayloadBuilder appendString(String string) {
		append(string.getBytes(DEFAULT_STRING_ENCODING));
		return this;
	}

	public MessagePayloadBuilder appendString(String string, Charset charset) {
		append(string.getBytes(charset));
		return this;
	}
