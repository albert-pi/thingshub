					...
					encounter.register(new InjectionListener<I>() {
						...
						public void afterInjection(final I injectee) {
							try {
								...
								throw new RuntimeException(String.format("Failed to process annotation %s on method %s of class %s",
										annotationClazz.getSimpleName(), method.getName(), injectee.getClass().getSimpleName()), ex);
							}
						}
