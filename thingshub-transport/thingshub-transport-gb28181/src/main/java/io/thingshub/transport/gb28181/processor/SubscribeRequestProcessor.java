...
public class SubscribeRequestProcessor extends Processor<BaseChannelContext, SubscribeRequest> {

	@Override
	public void process(@NonNull BaseChannelContext ctx, @NonNull SubscribeRequest request) {
		// TODO
	}
