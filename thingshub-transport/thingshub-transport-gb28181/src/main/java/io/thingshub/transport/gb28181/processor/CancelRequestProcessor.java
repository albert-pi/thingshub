...
public class CancelRequestProcessor extends Processor<BaseChannelContext, CancelRequest> {

	@Override
	public void process(@NonNull BaseChannelContext ctx, @NonNull CancelRequest request) {
		// TODO
	}
