...
public class NotifyRequestProcessor extends Processor<BaseChannelContext, NotifyRequest> {

	@Override
	public void process(@NonNull BaseChannelContext ctx, @NonNull NotifyRequest request) {
		// TODO
	}
