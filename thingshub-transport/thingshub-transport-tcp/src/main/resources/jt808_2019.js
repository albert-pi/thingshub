this.decode = function (bytes) {	
	...
	switch (msgType) {
		case 0x01:
			...
			stdPayload["method"] = "thing.rpc.auth.call";
		...
		case 0x05:
			...
			stdPayload["id"] = ""; 
			stdPayload["version"] = "1.0";
			stdPayload["method"] = "thing.rpc.checkBillingStrategy.call";
			stdPayload["params"] = params;	
	  ...
	  case 0x09:
	  	params["equipId"] = IntOps.static.intFromBytes(payloadBytes, 0, 1);
			...
			stdPayload["id"] = ""; 
			stdPayload["version"] = "1.0";
			stdPayload["method"] = "thing.rpc.getBillingStrategy.call";
			stdPayload["params"] = params;	
	  ...
	  case 0x31:	
	  	...
	  	//TODO ...
			...
			stdPayload["id"] = ""; 
			stdPayload["version"] = "1.0";
			stdPayload["method"] = "thing.rpc.startCharging.call";
			stdPayload["params"] = params;	
	  ...
	  case 0x57:  	
	  	...
	  	//TODO ...
			...
			stdPayload["id"] = ""; 
			stdPayload["version"] = "1.0";
			stdPayload["method"] = "thing.service.setBillingStrategy.call_reply";
			stdPayload["params"] = params;
	  ...
	  case 0xA1:  	
	  	...
	  	//TODO ...
			...
			stdPayload["id"] = ""; 
			stdPayload["version"] = "1.0";
			stdPayload["method"] = "thing.rpc.launchMultiCharging.call";
			stdPayload["params"] = params;
...
this.encode = function (msg) {
	...
	switch (theMethod) {
		case "thing.rpc.auth.call_reply":
		...
		case "thing.event.heartbeat.post_reply":
			...
			break;
	  case "thing.rpc.checkBillingStrategy.call_reply":
	  	...
	  	break;
	  case "thing.rpc.getBillingStrategy.call_reply":
	  ...
	  case "thing.service.getChargingMetric.call":
	    ...
	    break;
	  case "thing.rpc.startCharging.call_reply":
	  ...
	  case "thing.service.queryCards.call":
	  	...
	  	break;
	  case "thing.property.workParametes.set":
	  	msgBytes.push(IntOps.static.intToByte(13));
			msgBytes.push(...IntOps.static.intTo2Bytes(theId));
			msgBytes.push(0x00);
	  	msgBytes.push(0x52);
	  ...
	  case "thing.service.syncClock.call":
	  	...
	  	break;
	  case "thing.service.setBillingStrategy.call":
	  	msgBytes.push(0x58);
	  ...
	  case "thing.service.upgrade.call":
	  	...
	  	break;
	  case "thing.rpc.launchMultiCharging.call_reply":
	  	msgBytes.push(0xA2);
